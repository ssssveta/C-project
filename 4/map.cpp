...
Map::Map(QWidget *parent): QWidget(parent)
{
   ...
   //this->setCentralWidget(map);
    ...
    map->setMapSettingsFlags(map->mapSettings().flags() | QgsMapSettings::RenderPreviewJob);
    map->setCachingEnabled(true);
    map->setPreviewJobsEnabled(true);
    map->setMapUpdateInterval(500);
    //map->setMinimumSize(800, 600);
